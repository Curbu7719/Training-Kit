...
const tr = {
  ...
  'cert.incomplete.desc': 'Sertifikanı açmak için programın tamamını bitir:',
  'cert.req.modules': 'Tüm zorunlu modüller geçildi',
  'cert.req.exam': 'SDLC sınavı geçildi',
  'cert.req.reflection': 'Tamamlama yazısı (reflection) yazıldı',
  ...
  'admin.users.col.online': 'Durum',
  'admin.users.online': 'Çevrimiçi',
  'admin.users.offline': 'Çevrimdışı',
  'admin.users.onlineCount': 'Şu an {total} kullanıcıdan {count} çevrimiçi',
  ...
  'welcome.mascot': 'Tanış: Wingmate — AI yol arkadaşın',
