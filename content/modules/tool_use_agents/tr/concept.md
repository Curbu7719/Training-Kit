...
**Korkuluklar (guardrails)** bunları yönetir: döngüleri durdurmak için bir **maksimum-iterasyon sınırı**, **zaman aşımları ve bütçeler**, push veya silme gibi riskli eylemler için **insan onayı** ve çalıştırmadan önce **tool girdilerini doğrulama**. Otonomi yalnızca sınırlandığında güçlüdür. Kurum içi **AI Agent platformumuz** tam da bunun her rol için bir araya geldiği yerdir: agent’ları ve onaylı tool’ları bu sınırlar — iterasyon limitleri, onay kapıları, girdi doğrulama — yerleşik olarak sunar; böylece bunları her projede yeniden kurmak yerine güvenli varsayılanların üzerine inşa edersin.
